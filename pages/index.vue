<template>
  <div>
    ...
    <div id="info">
      <a href="https://threejs.org" target="_blank" rel="noopener">three.js</a> - decal splatter
      <br />click to shoot
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    function init() {
      ...
      var hemiLight = new THREE.HemisphereLight(0xffffff, 0xffffff, 0.64);
    ...
    function loadLeePerrySmith() {
      ...
      loader.load("model/car10.glb", function(gltf) {
        ...
        //   }
        // });
        console.log(gltf.scene.children[57]);
        mesh = gltf.scene.children[57];
